        ...
        <div className="modal-content" onClick={onclose}>
            <div className="modal-overlay" onClick={(e)=>e.stopPropagation()} >
                <form className="modal-form" onSubmit={handleSubmit}>
                    ...
                    <input type="text" name="username" id="username" value={username} onChange={(e)=>{setusername(e.target.value)}} required></input><br/>
                    <label htmlFor="email">Email Address: </label><br/>
                    <input type="email" name= "email" id="email" value={emailAdd} required onChange={(e)=>{setEmailAdd(e.target.value)}} ></input><br/>
...
export default function ModalApp (){
    ...
    return (
        ...
        <div className="modal">
            ...
            <button type="button" onClick={(e)=>handleOpen(e)} className="btn">Open Form</button>
